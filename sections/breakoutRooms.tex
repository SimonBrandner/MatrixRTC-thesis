...
\mintinline{text}{""}) \parencite{GitHub-MSC3985} -- v Matrix místnosti vždy existuje
jen jedna validní state událost s danou dvojicí \mintinline{text}{type} a
\mintinline{text}{state_key} \parencite{MatrixORG-Spec}.
...
\mintinline{typescript}{MatrixClient} \parencite{GitHub-MatrixJSSDK-BreakoutRooms}.
...
mezi uživateli pomocí URL \parencite{GitHub-ElementCall-CompleteSPAE2EEWork}. Bude
