...
\href{https://github.com/matrix-org/matrix-js-sdk/pull/3753/}{na GitHubu}
\parencite{GitHub-MatrixJSSDK-BreakoutRooms} \iftoggle{school}{a v příloze (viz
    část \ref{attachment})}{}.
...
Změny, které budeme v této části práce popisovat, lze nalézt
\href{https://github.com/vector-im/element-call/pull/1615/}{na GitHubu}
\parencite{GitHub-ElementCall-BreakoutRooms} \iftoggle{school}{a v příloze (viz
    část \ref{attachment})}{}.
