...
\parencite{WebRTCORG-PeerConnections}. To přináší otázku, zda a jak využít tuto
...
\parencite{MagnusWesterlund-GlareInWebRTC}. Někdy také dochází k lexikografickému
porovnání identifikátorů klientů pro zvolení klienta, který bude kontaktovat
toho druhého \parencite{GitHub-MSC3401}.
...
(obvykle je maximum 5 - 8 klientů) \parencite{BlogGeek-WebRTCP2PMesh}.
...
nevýhod \parencite{Red5Pro-WebRTCScalingApproaches}.
...
E2EE~\parencite{ITSecurityKnowHow-E2EGainsANewMeaning}.
...
streamů přeposílá ostatním klientům \parencite{HalOpenScience-SFUs}, jak je vidět na
obrázku č. \ref{sfu}.

Toto řešení má několik výhod -- umožňuje E2EE, neboť nepotřebuje streamy
transkódovat a mixovat \parencite{WebRTCHacks-TrueE2EE}. Z tohoto důvodu také nemá
...
\parencite{LiveKit-SimulcastIntroduction}.
