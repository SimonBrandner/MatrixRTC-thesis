...
Jedním z projektů, který využívá MatrixRTC, je \href{https://thirdroom.io}{Third
    Room} \cite{ThirdRoom-Homepage}. Jedná se o vizi otevřeného
Metaverse\footnote{
    ...
    \cite{TechTarget-WhatIsTheMetaverse}
...
a \href{https://rapier.rs/}{Rapier}. Jako své Matrix SDK využívá \href{https://www.npmjs.com/package/hydrogen-view-sdk}{Hydrogen SDK} \cite{ThirdRoom-Homepage}.
...
čase~\cite{GitHub-TheBoard}. TheBoard aktuálně MatrixRTC nevyužívá, ale je to
