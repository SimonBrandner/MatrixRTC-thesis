...
\href{https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax}{GitHub-flavored Markdownu}\footnote{
    ...
    používá GitHub \parencite{GitHub-Markdown}.
} a popisuje problém, který se MSC snaží vyřešit, možnosti řešení a výhody a
nevýhody daných přístupů k řešení \parencite{MatrixORG-MSCs}.
...
souhlas 75~\% SCT \parencite{MatrixORG-MSCs}.
...
specifikace a bude v další stabilní verzi \parencite{MatrixORG-MSCs}.
...
jsou např. týmy v aplikace MS Teams) \parencite{MatrixORG-Spec}.
...
spojení \parencite{MatrixORG-Spec}.
...
V tento moment existují pravděpodobně stovky Matrix SDKs\footnote{
    ...
    vývoj na dané platformě \parencite{RedHat-WhatIsAnSDK}.
} a klientů, z nichž je většina vyvíjena komunitou. Mezi ty známé patří např.
Element~\parencite{Element-Homepage}, Hydrogen \parencite{GitHub-Hydrogen}, Nheko
\parencite{GitHub-Nheko}, FluffyChat \parencite{FluffyChat-Homepage} či Cinny
\parencite{Cinny-Homepage}.

Element je všeobecný klient pro Matrix chat \parencite{Element-Homepage}, jeho webová
verze používá SDK
...
referenčních implementací protokolu Matrix \parencite{GitHub-MatrixJSSDK}. Desktopová
verze Elementu je pak Electron\footnote{
    Electron je framework pro vytváření desktopových aplikací pomocí webových
    technologií \parencite{ElectronJS-Homepage}.
} wrapper jeho webové verze \parencite{GitHub-ElementDesktop}. Hydrogen je rovněž
...
měl by běžet i~v~prohlížečích, jako je Internet Explorer\footnote{
    ...
    \parencite{ZealousSites-WhyDoWebDevelopersHateInternetExplorer}.
} \parencite{GitHub-Hydrogen}.

Android a iOS verze Elementu využívají každá své vlastní SDK (v Kotlinu a
Objective C) \parencite{GitHub-ElementAndroid,GitHub-ElementIOS}, probíhá však vývoj
...
desktopu \parencite{FluffyChat-Homepage,GitLab-FluffyChat}.
...
jazyce Go a má být nástupce Synapse \parencite{GitHub-Dendrite}. Poslední implementací
\href{https://github.com/timokoesters/conduit}{Conduit}, která je napsaná v
jazyce Rust a je spravovaná komunitou \parencite{GitHub-Conduit}.
...
podporovalo federované systémy, rozšíření se pak nazývá \textit{Decentralized
    Message Layer Security} \parencite{AreWeMLSYet}.
