...
DTMF\footnote{
    ...
    komunikaci mezi zařízeními \parencite{DSTNY-DTMF}.
} \parencite{GitHub-MSC2746}. MSC3077 přidává podporu pro hovory s více streamy
(např. sdílení obrazovek) \parencite{GitHub-MSC3077}. MSC3291 pak specifikuje sdílení
metadat o streamech (např. zda je audio či video ztlumené)
\parencite{GitHub-MSC3291}.

MSC3401 přidává podporu pro skupinové full-mesh hovory \parencite{GitHub-MSC3401}.
...
\parencite{MatrixORG-Spec}. Například JavaScript API pro WebRTC umožňuje kandidáty
...
měl obsahovat \mintinline{text}{description} s \mintinline{text}{sdp} (SDP offer
...
\mintinline{text}{reason}, která nabývá několika hodnot \parencite{GitHub-MSC2746}:
\begin{itemize}
    \itemsep0em
...
zařízení se účastní jakého hovoru \parencite{GitHub-MSC3401}. Neobsahuje-li událost
...
klientů je popsáno v části \ref{foci} \parencite{GitHub-MSC3898}. Následně se mezi
jednotlivými zařízeními využívá to-device messages, které jsou ve stejném
formátu jako události popsané v části \ref{dmCalls} \parencite{GitHub-MSC3401}.
...
\parencite{GitHub-MatrixJSSDK}. Zároveň se na experimentálním větvi pracuje na
podpoře MSC3898 \parencite{GitHub-MatrixJSSDK-MSC3898}.
