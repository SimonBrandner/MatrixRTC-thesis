...
Pro předání dalších ICE kandidátů druhému klientovi je použita událost s~typem
\mintinline{text}{m.call.candidates}, která obsahuje
\mintinline{text}{candidates}, což je seznam ICE kandidátů
\parencite{MatrixORG-Spec}. Například JavaScript API pro WebRTC umožňuje
kandidáty konvertovat do JSON pomocí
