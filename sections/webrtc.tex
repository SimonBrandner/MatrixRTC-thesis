...
(např.~\href{https://github.com/pion/webrtc}{Pion}~\parencite{GitHub-Pion-WebRTC} či
\href{https://github.com/webrtc-rs/webrtc}{WebRTC.rs}~\parencite{GitHub-WebRTCRS-WebRTC})
v jiných jazycích \parencite{WebRTCForTheCurious}.
...
serveru)\footnote{Address Dependent mapování lze často také nalézt pod pojmem
    ...
    nelze snadno klasifikovat do kategorií \parencite{IETF-RFC4787}.}. STUN naštěstí
umožňuje zjištění typu NAT mapování, takže klient předem ví, jestli ho bude
možné kontaktovat \parencite{WebRTCForTheCurious}.
...
protokol (může být UDP nebo TCP) a port~\parencite{WebRTCForTheCurious}.
...
posílal pakety \parencite{WebRTCForTheCurious}.

Klient 1 může posílat na TURN server \textit{Send Indication}, která obsahuje
data, které se mají přeposlat klientovi 2 \parencite{WebRTCForTheCurious}.
...
serveru upraven a IP adresa a port dodány \parencite{WebRTCForTheCurious}.
...
používá se znak \mintinline{text}{-} \parencite{IETF-RFC8866}. Záleží na pořadí
