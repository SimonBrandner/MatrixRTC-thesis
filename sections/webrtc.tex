...
\begin{figure}[H]
	...
	\begin{tikzpicture}[every node/.style={rectangle, rounded corners=2mm}]
		\node[draw] (router1) at (0,-1.5) {Router 1 (1.0.0.1)};
		\node[draw] (client1) at (-3,-3) {Klient 1 (192.168.0.1)};
		\node[draw] (client2) at (3,-3) {Klient 2 (192.168.0.2)};

		\node[draw] (internet) at (0,0) {Internet};

		\node[draw] (router2) at (0,1.5) {Router 2 (1.0.0.2)};
		\node[draw] (client3) at (0,3) {Klient 3 (192.168.0.1)};
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}[every node/.style={rectangle, rounded corners=2mm}]
		\node[draw] (router1) at (-3,0) {Router 1 (1.0.0.1)};
		\node[draw] (client1) at (-3,-1.5) {Klient 1 (192.168.0.1)};

		\node[draw] (router2) at (3,0) {Router 2 (1.0.0.2)};
		\node[draw] (client2) at (3,-1.5) {Klient 2 (192.168.0.2)};

		\node[draw] (internet) at (0,1.5) {Internet};
		\node[draw] (stunServer) at (0,3) {STUN server (1.0.0.3)};
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[every node/.style={rectangle, rounded corners=2mm}]
		...
		\node[draw] (turnServer) at (0,1.5) {TURN server (1.0.0.3)};
